...
int totalScore = session.getAttribute("score") != null ? (int) session.getAttribute("score") : 0;
String sql="SELECT * FROM tests";
PreparedStatement statement = conn.prepareStatement(sql);
ResultSet testQuery = statement.executeQuery();
if (!testQuery.next()) {
    out.println("No tests created by teacher");
} else {
    ResultSet testQuery2 = statement.executeQuery("SELECT * FROM tests");
      ...
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            ...
            <div class="number"><%out.println(numExams); %></div>
          </div>
...
flaky
        ...
        <div class="box">
          <div class="right-side">
            ...
            <div class="number"><%out.println(passExams); %></div>
            <div class="indicator">
            </div>
          </div>
          <span class="material-symbols-outlined">
        ...
        <div class="box">
          <div class="right-side">
            ...
            <div class="number"><%out.println(failExams); %></div>
            <div class="indicator">
            </div>
          </div>
          <span class="material-symbols-outlined">
        ...
        <div class="box">
          <div class="right-side">
            ...
            <div class="number"><%out.println(totalScore); %></div>
            <div class="indicator">
            </div>
          </div>
          <span class="material-symbols-outlined">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <div class="sales-details">
            Available exams:<% while (testQuery2.next()) {
                String testName = testQuery2.getString("test_name");
                out.println(testName);%>Status:
                <% if(totalScore!=0)
	 				out.println("Attempted");
				else
					out.println("Unattempted");
			 }
                // do something with testName
            } %> 
          </div>
          <div class="sales-details">
              Enter name of test you want to give: <br>
              <input type="text" name="selected_test"/>
            </div>
            <div class="button">
        ...
        <div class="top-sales box">
          ...
          <li>
            <span class="stu-details"><b>Enrollment No: <%out.println(" "+enrollment); %></b> </span>
          </li>
          <li>
